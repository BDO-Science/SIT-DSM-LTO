---
date: "`r Sys.Date()`"
title: "All SR SIT DSM Summary Tables - BA"
output: 
...
table1 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_AllSpawners.csv")))
...
table2 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_NatSpawners.csv")))
...
table3 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_MeanLambda.csv")))
table3$WYT <- "All"

mlambda_wyt <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_WYTMeanLambda.csv")))
...
table4 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_EndLambda.csv")))
...
table5 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_SRearUSR.csv")))
...
table6 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_VLMigrUM.csv")))
...
table7 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_VLMigrLM.csv")))
...
table8 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_VLMigrLL.csv")))
...
table9 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_VLMigrNDelta.csv")))
...
table10 <- read.csv(here(paste0("springRunDSM-Main/Output/Tables/BA_VLMigrSDelta.csv")))
