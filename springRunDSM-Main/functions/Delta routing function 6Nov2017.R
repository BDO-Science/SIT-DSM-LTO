...
route.2.sDlt<- function(Qfpt, DCCgate.pos, vary, pctil){
  ...
  #open<-30-DCCgate.pos 
  DCCgate.pos<-round(min(DCCgate.pos,30)) #treat each month as 30 days / ** AJ: added round to deal w/ issues w/ non-integers for CalSim 3 input
  open<-round(30-DCCgate.pos) # ** AJ: added round to deal w/ issues w/ non-integers for CalSim 3 input
