...
write.csv(df.table1, paste0("./winterRunDSM-Main/Output/Tables/EIS_AllSpawners.csv"),
          row.names=FALSE)
...
df.table1b <- df.table1 %>%
  ...
  select(Year, Alt1,`Alt2wTUCPwoVA`,`Alt2woTUCPwoVA`,`Alt2woTUCPDeltaVA`,
         ...
         Alt3,
         Alt4)
write.csv(df.table1b, paste0("./winterRunDSM-Main/Output/Tables/EIS_AllSpawnersPercDiff.csv"),
          row.names=FALSE)
...
df.table2 <- spawn_df %>%
  ...
  select(Year, alt_plot_names)
write.csv(df.table2, paste0("./winterRunDSM-Main/Output/Tables/EIS_NatSpawners.csv"),
          row.names=FALSE)
...
df.table2b <- df.table2 %>%
  ...
  select(Year, Alt1,`Alt2wTUCPwoVA`,`Alt2woTUCPwoVA`,`Alt2woTUCPDeltaVA`,
         ...
         Alt3,
         Alt4)
write.csv(df.table2b, paste0("./winterRunDSM-Main/Output/Tables/EIS_NatSpawnersPercDiff.csv"),
          row.names=FALSE)
...
write.csv(df.table3, paste0("./winterRunDSM-Main/Output/Tables/EIS_MeanLambda.csv"),
          row.names=FALSE)
...
df.table3b <- df.table3 %>%
  ...
  select(Alt1,`Alt2wTUCPwoVA`,`Alt2woTUCPwoVA`,`Alt2woTUCPDeltaVA`,
         ...
         Alt3,
         Alt4)
write.csv(df.table3b, paste0("./winterRunDSM-Main/Output/Tables/EIS_MeanLambdaPercDiff.csv"),
          row.names=FALSE)
...
write.csv(mlambda_wyt_df, paste0("./winterRunDSM-Main/Output/Tables/EIS_WYTMeanLambda.csv"),
          row.names=FALSE)
...
mlambda_wyt_dfb <- mlambda_wyt_df %>%
  ...
  select(WYT,Alt1,`Alt2wTUCPwoVA`,`Alt2woTUCPwoVA`,`Alt2woTUCPDeltaVA`,
         ...
         Alt3,
         Alt4)
write.csv(mlambda_wyt_dfb, paste0("./winterRunDSM-Main/Output/Tables/EIS_WYTMeanLambdaPercDiff.csv"),
          row.names=FALSE)
...
df.table4 <- tibble(`End Lambda`=end_lambda,
  ...
  as.data.frame() %>%
  select(alt_plot_names)
write.csv(df.table4, paste0("./winterRunDSM-Main/Output/Tables/EIS_EndLambda.csv"),
          row.names=FALSE)
...
df.table4b <- df.table4 %>%
  ...
  select(Alt1,`Alt2wTUCPwoVA`,`Alt2woTUCPwoVA`,`Alt2woTUCPDeltaVA`,
         ...
         Alt3,
         Alt4)
write.csv(df.table4b, paste0("./winterRunDSM-Main/Output/Tables/EIS_EndLambdaPercDiff.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/EIS_SRearUSR.csv"),
          row.names=FALSE)
...
df.tablexb <- df.tablex %>%
  ...
  select(WYT,Month,
         ...
         Alt3,
         Alt4)
write.csv(df.tablexb, paste0("./winterRunDSM-Main/Output/Tables/EIS_SRearUSRPercDiff.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrUM.csv"),
          row.names=FALSE)
...
df.tablexb <- df.tablex %>%
  ...
  select(WYT,Month,
         ...
         Alt3,
         Alt4)
write.csv(df.tablexb, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrUMPercDiff.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrLM.csv"),
          row.names=FALSE)
...
df.tablexb <- df.tablex %>%
  ...
  select(WYT,Month,
         ...
         Alt3,
         Alt4)
write.csv(df.tablexb, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrLMPercDiff.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrLL.csv"),
          row.names=FALSE)
...
df.tablexb <- df.tablex %>%
  ...
  select(WYT,Month,
         ...
         Alt3,
         Alt4)
write.csv(df.tablexb, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrLLPercDiff.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrNDelta.csv"),
          row.names=FALSE)
...
df.tablexb <- df.tablex %>%
  ...
  select(WYT,Month,
         ...
         Alt3,
         Alt4)
write.csv(df.tablexb, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrNDeltaPercDiff.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrSDelta.csv"),
          row.names=FALSE)
...
df.tablexb <- df.tablex %>%
  ...
  select(WYT,Month,
         ...
         Alt3,
         Alt4)
write.csv(df.tablexb, paste0("./winterRunDSM-Main/Output/Tables/EIS_VLMigrSDeltaPercDiff.csv"),
          row.names=FALSE)
...
df.table1 <- spawn_df %>%
  ...
  pivot_wider(names_from=Alternative, values_from=`All Spawners`) %>%
  select(Year, alt_plot_names)
write.csv(df.table1, paste0("./winterRunDSM-Main/Output/Tables/BA_AllSpawners.csv"),
          row.names=FALSE)
...
df.table2 <- spawn_df %>%
  ...
  pivot_wider(names_from=Alternative, values_from=`Natural Spawners`) %>%
  select(Year, alt_plot_names)
write.csv(df.table2, paste0("./winterRunDSM-Main/Output/Tables/BA_NatSpawners.csv"),
          row.names=FALSE)
...
df.table3 <- tibble(`Mean Lambda`=lambda_mean,
  ...
  as.data.frame() %>%
  select(alt_plot_names)
write.csv(df.table3, paste0("./winterRunDSM-Main/Output/Tables/BA_MeanLambda.csv"),
          row.names=FALSE)
...
df.table4 <- tibble(`End Lambda`=end_lambda,
  ...
  as.data.frame() %>%
  select(alt_plot_names)
write.csv(df.table4, paste0("./winterRunDSM-Main/Output/Tables/BA_EndLambda.csv"),
          row.names=FALSE)
...
mlambda_wyt_df <- as_tibble(mlambda_wyt_df) %>%
  ...
  as.data.frame() %>%
  select(WYT, alt_plot_names)
write.csv(mlambda_wyt_df, paste0("./winterRunDSM-Main/Output/Tables/BA_WYTMeanLambda.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/BA_SRearUSR.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/BA_VLMigrUM.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/BA_VLMigrLM.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/BA_VLMigrLL.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/BA_VLMigrNDelta.csv"),
          row.names=FALSE)
...
write.csv(df.tablex, paste0("./winterRunDSM-Main/Output/Tables/BA_VLMigrSDelta.csv"),
          row.names=FALSE)
